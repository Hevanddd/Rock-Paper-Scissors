...
function loses(userChoice, computerChoice) {
  ...
  result_div.textContent = `${convertToWord(userChoice)} loses to ${convertToWord(computerChoice)}. You lost...`
...
function draws(userChoice, computerChoice) {
  result_div.textContent = `${convertToWord(userChoice)} equals ${convertToWord(computerChoice)}. It's a draw.`
